...
class TestRuntimeContext(unittest.TestCase):
            ...
            normalized,
            {
                "pipeline": {
                    ...
                    "metadata": {
                        ...
                        "params": {"threshold": 0.75, "max_items": 100, "debug_mode": True},
                    },
                    "settings": {"numbers": [1, 2, 3], "options": {"key": "value", "flag": True}},
                    "nested_list": [{"a": 1}, {"b": 2}],
                }
            },
        )
    ...
    def test_config_list(self):
        ...
        normalized = normalize_structure(data)
        self.assertEqual(normalized, {"items": [1, 2, 3.14, None, True, False, "quoted"]})
