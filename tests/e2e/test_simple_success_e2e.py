...
class TestSimpleSuccessE2E(unittest.TestCase):
    """
    End-to-end tests for simple file validation pipeline.
    """

    def setUp(self):
        self.test_dir = Path(__file__).parent / "resources" / "simple_success"
        self.justification_file = self.test_dir / "file_validation.json"
        self.config_file = self.test_dir / "config.yaml"
        self.python_file = self.test_dir / "file_validation.py"
    ...
    def test_simple_success_normal_execution(self):
        """
    ...
    def test_simple_success_with_valid_data(self):
        """
    ...
    def test_simple_fail_with_empty_data(self):
        """
    ...
    def test_simple_success_dry_run(self):
        """
    ...
    def test_simple_success_with_diagram_export(self):
        """
        Test diagram export functionality with simple success pipeline.
        """
